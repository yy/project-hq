...
In-repo Obsidian vault for project-hq. Holds ideas, designs, specs, and notes
that live alongside the code but aren't user-facing documentation.

Open this folder directly in Obsidian as a vault. Conventions:
